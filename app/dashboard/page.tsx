                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        value={
                          editDraft.cognitive_distortion ??
                        ...
                        onChange={(e) =>
                          setEditDraft((prev) => ({
                            ...prev,
                            cognitive_distortion: e.target.value,
                          }))
                        }
                      >
                        <option value="">None / Not sure</option>
                    ...
                    <div>
                      ...
                      <textarea
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900"
                        value={editDraft.outcome ?? entry.outcome ?? ""}
                        onChange={(e) =>
                          setEditDraft((prev) => ({
                            ...prev,
                    ...
                    <div className="flex justify-end gap-2 mt-3">
                      <button
                        ...
                        className="px-3 py-1 text-xs font-semibold text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50 transition"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="px-3 py-1 text-xs font-semibold text-green-600 border border-green-200 rounded-lg hover:bg-green-50 transition"
                      >
                        Save
                      </button>
                    </div>
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      <p className="text-gray-900">
                        ...
                        {entry.emotion}
                        <span className="ml-2 inline-block px-2 py-0.5 bg-blue-100 text-blue-700 text-xs font-medium rounded-full">
                          {entry.emotion_intensity}/10
                        </span>
                      </p>
                      {entry.cognitive_distortion && (
                        <p className="text-gray-900">
                    ...
                    <div className="flex justify-end gap-2 mt-4">
                      <button
                        ...
                        className="px-3 py-1 text-xs font-semibold text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 transition"
                      >
                        Edit
                      </button>
                      <button
                        ...
                        className="px-3 py-1 text-xs font-semibold text-red-600 border border-red-200 rounded-lg hover:bg-red-50 transition"
                      >
                        Delete
                      </button>
                    </div>
        ...
        {moodData.length > 0 && (
          <section className="mt-10 bg-white rounded-2xl shadow-sm border border-gray-200 p-5">
            ...
            <p className="text-xs text-gray-500 mb-4">
              Each point is an entry&apos;s emotion intensity (1–10) on the date
              it was logged.
            </p>
